...
| Methodology | The path: lifecycle and quality process | `product-development-workflow`, workflows, TDD, debugging, review, deployment, refactoring | Strong | compliance gates and human review policy |
